...
pub fn op_example(name: &str) -> Option<&'static str> {
    match name {
        ...
        "set_path_anchor_kind" => Some(
            r#"{"op":"set_path_anchor_kind","node":"path.logo","anchor_index":1,"kind":"smooth"}"#,
        ),
        "remove_path_anchor" => {
            Some(r#"{"op":"remove_path_anchor","node":"path.logo","anchor_index":1}"#)
        }
        "insert_path_anchor" => {
            Some(r#"{"op":"insert_path_anchor","node":"path.logo","segment_index":0,"t":0.5}"#)
        }
        "insert_path_anchor_at_point" => Some(
            r#"{"op":"insert_path_anchor_at_point","node":"path.logo","x":50,"y":2,"tolerance":4}"#,
        ),
        "move_path_anchor" => {
        ...
        "transform_path_anchors" => Some(
            r#"{"op":"transform_path_anchors","node":"path.logo","transform":{"mode":"translate","dx":10,"dy":-4}}"#,
        ),
