        ...
        Node::Connector(connector) => {
            ...
            compile_connector(
                ...
                ConnectorEnv {
                    ...
                    connector_closed_rings: field_ctx.connector_closed_rings,
                    connector_open_polylines: field_ctx.connector_open_polylines,
                    connector_path_geometries: field_ctx.connector_path_geometries,
