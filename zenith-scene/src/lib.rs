...
pub use ir::{
    BlendMode, Color, FilterKind, FilterSpec, FitMode, GradientPaint, GradientStop, ImageClip,
    LineCap, Rect, Scene, SceneCommand, SceneGlyph, ShadowSpec, SrcRect, StrokeAlign,
};
