...
fn op_name(op: &zenith_tx::Op) -> &'static str {
    match op {
        ...
        zenith_tx::Op::RemovePathAnchor { .. } => "remove_path_anchor",
        ...
        zenith_tx::Op::CreateStyle { .. } => "create_style",
        zenith_tx::Op::DeleteStyle { .. } => "delete_style",
        zenith_tx::Op::CreateMaster { .. } => "create_master",
        zenith_tx::Op::DeleteMaster { .. } => "delete_master",
        zenith_tx::Op::SetPageMaster { .. } => "set_page_master",
