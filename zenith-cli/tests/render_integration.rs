//! Integration test: read `examples/rect.zen` from the workspace root and
//! render it to a PNG, asserting the output is a valid, non-empty PNG and
//! that two back-to-back renders are byte-identical (determinism gate).
